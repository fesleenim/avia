        ...
        {[ 
          ...
          <div key={index} className="w-full sm:w-[48%] md:w-[31%] lg:w-[23%] h-[400px] bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 flex flex-col">
            ...
            <div className="p-5 flex flex-col flex-grow">
              ...
              <a href="#aloqa" className="inline-flex items-center justify-center w-full px-3 py-2 text-sm font-medium text-center text-white bg-[#F26522] rounded-lg hover:bg-[#F26522] focus:ring-4 focus:outline-none">
                Batafsil
              </a>
            </div>
          </div>
