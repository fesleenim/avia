        ...
        {[
          ...
          <div key={index} className="w-full sm:w-[48%] md:w-[31%] lg:w-[30%] h-[450px] bg-white border border-gray-200 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700 flex flex-col">
            ...
            <div className="p-5 flex flex-col flex-grow">
              ...
              <a href="#" className="inline-flex items-center justify-center w-full px-3 py-2 text-sm font-medium text-center text-white bg-[#F26522] rounded-lg hover:bg-[#d8541a] focus:ring-4 focus:outline-none">
                Batafsil ma'lumot
              </a>
            </div>
          </div>
